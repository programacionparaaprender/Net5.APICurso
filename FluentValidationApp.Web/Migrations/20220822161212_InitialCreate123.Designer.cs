...
namespace FluentValidationApp.Web.Migrations
{
    ...
    [Migration("20220822161212_InitialCreate123")]
            ...
            modelBuilder.Entity("FluentValidationApp.Web.Models.Carga", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CargaId = 1L,
                            Ciclo = new DateTime(2022, 8, 22, 11, 12, 12, 323, DateTimeKind.Local).AddTicks(5196),
                            Estado = "",
                            FechaProgramada = new DateTime(2022, 8, 22, 11, 12, 12, 328, DateTimeKind.Local).AddTicks(3364),
                            Fin = new DateTime(2022, 8, 22, 11, 12, 12, 328, DateTimeKind.Local).AddTicks(4233),
                            Hora = "",
                            Inicio = new DateTime(2022, 8, 22, 11, 12, 12, 328, DateTimeKind.Local).AddTicks(3954),
                            Tipo = "",
                            Usuario = "",
                            creado = new DateTime(2022, 8, 22, 11, 12, 12, 328, DateTimeKind.Local).AddTicks(4501)
                        });
                });
