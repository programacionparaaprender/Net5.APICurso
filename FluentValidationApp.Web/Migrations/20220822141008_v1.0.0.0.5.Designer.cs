...
namespace FluentValidationApp.Web.Migrations
{
    ...
    [Migration("20220822141008_v1.0.0.0.5")]
    partial class v10005
    {
            ...
            modelBuilder.Entity("FluentValidationApp.Web.Models.CampaniaFinanciamiento", b =>
                {
                    ...
                    b.ToTable("CampaniaFinanciamientos");
                });
            ...
            modelBuilder.Entity("FluentValidationApp.Web.Models.Carga", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CargaId = 1L,
                            Ciclo = new DateTime(2022, 8, 22, 9, 10, 7, 166, DateTimeKind.Local).AddTicks(1217),
                            Estado = "",
                            FechaProgramada = new DateTime(2022, 8, 22, 9, 10, 7, 173, DateTimeKind.Local).AddTicks(7231),
                            Fin = new DateTime(2022, 8, 22, 9, 10, 7, 173, DateTimeKind.Local).AddTicks(9570),
                            Hora = "",
                            Inicio = new DateTime(2022, 8, 22, 9, 10, 7, 173, DateTimeKind.Local).AddTicks(8667),
                            Tipo = "",
                            Usuario = "",
                            creado = new DateTime(2022, 8, 22, 9, 10, 7, 174, DateTimeKind.Local).AddTicks(302)
                        });
                });
